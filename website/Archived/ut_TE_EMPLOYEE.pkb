...
IS
   ...
   BEGIN
      ...
      utplsql.addtest ('DEL1');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_DEL1 AS
            SELECT * FROM employee';
      utplsql.addtest ('DELBY_EMP_DEPT_LOOKUP');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_DELBY_EMP_DEPT_LOOKUP AS
            SELECT * FROM employee';
      utplsql.addtest ('DELBY_EMP_JOB_LOOKUP');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_DELBY_EMP_JOB_LOOKUP AS
            SELECT * FROM employee';
      utplsql.addtest ('DELBY_EMP_MGR_LOOKUP');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_DELBY_EMP_MGR_LOOKUP AS
            SELECT * FROM employee';
      utplsql.addtest ('INS1');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_INS1 AS
            SELECT * FROM employee';
      utplsql.addtest ('UPD1');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_UPD1 AS
            SELECT * FROM employee';
      utplsql.addtest ('UPD$HIRE_DATE1');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_UPD$HIRE_DATE1 AS   
            SELECT * FROM employee';
      utplsql.addtest ('UPD$SALARY1');
      EXECUTE IMMEDIATE 'CREATE TABLE ut_UPD$SALARY1 AS
            SELECT * FROM employee';
      utplsql.addtest ('EMP_DEPT_LOOKUPROWCOUNT');
      utplsql.addtest ('EMP_JOB_LOOKUPROWCOUNT');
      utplsql.addtest ('EMP_MGR_LOOKUPROWCOUNT');
      utplsql.addtest ('HIRE_DATE$VAL');
      utplsql.addtest ('I_EMPLOYEE_NAME$ROW');
      utplsql.addtest ('I_EMPLOYEE_NAME$VAL');
      utplsql.addtest ('ONEROW');
      utplsql.addtest ('PKYROWCOUNT');
      utplsql.addtest ('ROWCOUNT');
      utplsql.addtest ('SALARY$VAL');
   END;

...
create or replace package body mystats_pkg as
   ...
   */
   ...
   begin
      dbms_output.put_line('- MyStats v2.01 by Adrian Billington (http://www.oracle-developer.net)');
   ...
   ------------------------------------------------------------------------------
   procedure ms_stop( p_statname_like in varchar2 ) is
   begin

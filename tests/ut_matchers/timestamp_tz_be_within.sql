...
declare
  ...
  l_value_lower timestamp with time zone := to_timestamp_tz('1997-01-31 09:14:25.00 +02:00','YYYY-MM-DD HH24.MI.SS.FF TZR');
  l_value_upper timestamp with time zone := to_timestamp_tz('1997-01-31 08:45:36.00 +02:00','YYYY-MM-DD HH24.MI.SS.FF TZR');
  l_result integer;

...
--@@lib/RunTest.sql ut/ut.run.function.WithPackageName.ExecutesAllFromGivenPackageOnly.sql --TODO this one doesn't work at the moment
...
--@@lib/RunTest.sql ut/ut.run.WithPackageName.ExecutesAllFromGivenPackageOnly.sql --TODO this one doesn't work at the moment
...
@@lib/RunTest.sql ut/ut.set_nls.ConsecutiveCallsDoNotImpactResetBehavior.sql
@@lib/RunTest.sql ut/ut.set_nls.SetsNLSDateFormatWithTime.sql

CREATE OR REPLACE PACKAGE BODY test_te_employee
IS
   ...
   BEGIN
      test_teardown;
      EXECUTE IMMEDIATE 'CREATE TABLE test_employee AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_DEL1 AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_DELBY_EMP_DEPT_LOOKUP AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_DELBY_EMP_JOB_LOOKUP AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_DELBY_EMP_MGR_LOOKUP AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_INS1 AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_UPD1 AS
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_UPD$HIRE_DATE1 AS   
            SELECT * FROM employee';
      EXECUTE IMMEDIATE 'CREATE TABLE test_UPD$SALARY1 AS
            SELECT * FROM employee';
   END;
   ...
   BEGIN
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_employee';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_DEL1';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_DELBY_EMP_DEPT_LOOKUP';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_DELBY_EMP_JOB_LOOKUP';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_DELBY_EMP_MGR_LOOKUP';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_INS1';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_UPD1';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_UPD$HIRE_DATE1';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
      ...
      BEGIN
         EXECUTE IMMEDIATE 'DROP TABLE test_UPD$SALARY1';
      EXCEPTION
         WHEN OTHERS
         THEN
            NULL;
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE '
      DELETE FROM test_DEL1
       WHERE employee_id = -1
      ';
      te_employee.del (-1, rowcount_out => fdbk);
      -- Test results
      utassert.eqtable ('Delete rows', 'EMPLOYEE', 'test_DEL1');
      /* Successful delete */
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE '
      DELETE FROM test_DELBY_EMP_DEPT_LOOKUP
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE '
      DELETE FROM test_DELBY_EMP_JOB_LOOKUP
       WHERE job_id = -1
      ';
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE '
      DELETE FROM test_DELBY_EMP_MGR_LOOKUP
       WHERE manager_id = -1
      ';
   ...
   BEGIN
      ...
      utassert.eqquery (
         ...
         DEPARTMENT_ID,
         CHANGED_BY,
         CHANGED_ON from test_ins1 where changed_on = ''' ||
            SYSDATE ||
            ''''
      );
      utassert.eqtabcount (
   ...
   BEGIN
      ...
      utassert.eqquery (
         ...
         'select first_name, commission, hire_date from test_upd1'
      );
      ROLLBACK;
   END;
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE '
      UPDATE test_UPD$HIRE_DATE1 SET
      ...
      utassert.eqquery (
         ...
         'select hire_date from test_UPD$HIRE_DATE1'
      );
      ROLLBACK;
   END;
   ...
   BEGIN
      ...
      utassert.eqquery (
         ...
         'select salary from test_UPD$SALARY1'
      );
      ROLLBACK;
   END;
   ...
   EXCEPTION
      WHEN OTHERS
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_EMP_DEPT_LOOKUPROWCOUNT exception ' ||
               SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_EMP_JOB_LOOKUPROWCOUNT exception ' ||
               SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_EMP_MGR_LOOKUPROWCOUNT exception ' ||
               SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_HIRE_DATE$VAL exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_I_EMPLOYEE_NAME$ROW exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_I_EMPLOYEE_NAME$VAL exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_PKYROWCOUNT exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_ROWCOUNT exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;
   ...
   EXCEPTION
      ...
      THEN
         -- Force registration of test failURE test_.
         utassert.this (
            'test_SALARY$VAL exception ' || SQLERRM,
            SQLCODE = 0
         );
   END;

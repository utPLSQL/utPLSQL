...
@@install_component.sql 'core/types/ut_key_anyval_pair.tps'
@@install_component.sql 'core/types/ut_key_anyval_pairs.tps'
@@install_component.sql 'core/types/ut_key_varcharvalue_pair.tps'
@@install_component.sql 'core/types/ut_key_xmlvalue_pair.tps'

...
grant execute on ut_coverage_options to &ut3_user;
...
grant execute on ut_file_mappings to &ut3_user;
grant execute on ut_file_mapping to &ut3_user;
grant execute on ut_file_mapper to &ut3_user;
...
create or replace synonym &ut3_user .ut_coverage_options for ut_coverage_options;
...
create or replace synonym &ut3_user .ut_file_mappings for ut_file_mappings;
create or replace synonym &ut3_user .ut_file_mapping for ut_file_mapping;
create or replace synonym &ut3_user .ut_file_mapper for ut_file_mapper;

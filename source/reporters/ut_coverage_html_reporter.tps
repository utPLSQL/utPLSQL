...
(
  coverage_id integer,
  constructor function ut_coverage_html_reporter(self in out nocopy ut_coverage_html_reporter, a_output ut_output default ut_output_dbms_output()) return self as result,

create or replace type ut_coverage_xml_reporter force under ut_coverage_reporter_base(
  /*
  ...
  */
  ...
  overriding member procedure after_calling_run(self in out nocopy ut_coverage_xml_reporter, a_run in ut_run)
)
/

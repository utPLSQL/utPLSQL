create or replace type equal under ut_expectation(
  ...
  overriding member function run_expectation(self in equal, a_actual ut_data_value_timestamp_ltz) return ut_assert_result,
  overriding member function run_expectation(self in equal, a_actual ut_data_value_timestamp_tz) return ut_assert_result
)
/

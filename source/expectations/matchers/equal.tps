create or replace type equal under ut_matcher(
  ...
  constructor function equal(self in out nocopy equal, a_expected sys_refcursor, a_nulls_are_equal boolean := null) return self as result,

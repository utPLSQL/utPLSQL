create or replace type ut_equal under ut_comparison_matcher(
  ...
  */
  ...
  constructor function ut_equal(self in out nocopy ut_equal, a_expected anydata, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null) return self as result,
  ...
  constructor function ut_equal(self in out nocopy ut_equal, a_expected anydata, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) return self as result,
  ...
  constructor function ut_equal(self in out nocopy ut_equal, a_expected sys_refcursor, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null) return self as result,
  ...
  constructor function ut_equal(self in out nocopy ut_equal, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) return self as result,

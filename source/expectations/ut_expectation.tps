create or replace type ut_expectation as object(
  ...
  not instantiable member function run_expectation(self in ut_expectation, a_actual ut_data_value_timestamp_tz) return ut_assert_result,
  not instantiable member function run_expectation(self in ut_expectation, a_actual ut_data_value_timestamp_ltz) return ut_assert_result,

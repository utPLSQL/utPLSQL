create or replace type ut_expectation authid current_user as object(
  ...
  */
  ...
  member procedure to_equal(self in ut_expectation, a_expected anydata, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null),
  ...
  member procedure to_equal(self in ut_expectation, a_expected anydata, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null),
  ...
  member procedure to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null),
  ...
  member procedure to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null),
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected anydata, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null),
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected anydata, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null),
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null),
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null),

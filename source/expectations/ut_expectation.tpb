create or replace type body ut_expectation as
  ...
  */
  ...
  begin
    ut_utils.debug_log('ut_expectation.to_be_true(self in ut_expectation)');
    self.to_( ut_be_true() );
  end;

  member procedure to_be_false(self in ut_expectation) is
  begin
    ut_utils.debug_log('ut_expectation.to_be_false(self in ut_expectation)');
    self.to_( ut_be_false() );
  end;

  member procedure not_to_be_true(self in ut_expectation) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_true(self in ut_expectation)');
    self.not_to( ut_be_true() );
  end;

  member procedure not_to_be_false(self in ut_expectation) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_false(self in ut_expectation)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_empty(self in ut_expectation)');
    self.not_to( ut_be_empty() );
  end;


  member procedure to_equal(self in ut_expectation, a_expected anydata, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.to_( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.to_( ut_equal(a_expected, a_exclude, null, a_nulls_are_equal) );
  end;

  member procedure to_equal(self in ut_expectation, a_expected anydata, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.to_( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  member procedure to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null) is
  begin
  ...
  member procedure to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null)');
    self.to_( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected anydata, a_exclude varchar2 := null, a_include varchar2 := null, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.not_to( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.not_to( ut_equal(a_expected, a_exclude, null, a_nulls_are_equal) );
  end;

  member procedure not_to_equal(self in ut_expectation, a_expected anydata, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_equal(self in ut_expectation, a_expected anydata, a_nulls_are_equal boolean := null)');
    self.not_to( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude varchar2 := null, a_include varchar2 := null,a_nulls_are_equal boolean := null) is
  begin
  ...
  member procedure not_to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list := null, a_include ut_varchar2_list, a_nulls_are_equal boolean := null) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_equal(self in ut_expectation, a_expected sys_refcursor, a_exclude ut_varchar2_list, a_nulls_are_equal boolean := null)');
    self.not_to( ut_equal(a_expected, a_exclude, a_include, a_nulls_are_equal) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.to_be_like(self in ut_expectation, a_mask in varchar2, a_escape_char in varchar2 default null)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_like(self in ut_expectation, a_mask in varchar2, a_escape_char in varchar2 default null)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_match(self in ut_expectation, a_pattern in varchar2, a_modifiers in varchar2 default null)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.to_be_between(self in ut_expectation_date, a_lower_bound number, a_upper_bound number)');
    self.to_( ut_be_between(a_lower_bound,a_upper_bound) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound date, a_upper_bound date)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound dsinterval_unconstrained, a_upper_bound dsinterval_unconstrained)');
    self.not_to( ut_be_between(a_lower_bound,a_upper_bound) );
  end;

  member procedure not_to_be_between(self in ut_expectation, a_lower_bound number, a_upper_bound number) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation_date, a_lower_bound number, a_upper_bound number)');
    self.not_to( ut_be_between(a_lower_bound,a_upper_bound) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound timestamp_unconstrained, a_upper_bound timestamp_unconstrained)');
    self.not_to( ut_be_between(a_lower_bound, a_upper_bound) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound timestamp_ltz_unconstrained, a_upper_bound timestamp_ltz_unconstrained)');
    self.not_to( ut_be_between(a_lower_bound, a_upper_bound) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound timestamp_tz_unconstrained, a_upper_bound timestamp_tz_unconstrained)');
    self.not_to( ut_be_between(a_lower_bound, a_upper_bound) );
  end;

  member procedure not_to_be_between(self in ut_expectation, a_lower_bound varchar2, a_upper_bound varchar2) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_between(self in ut_expectation, a_lower_bound varchar2, a_upper_bound varchar2)');
    self.not_to( ut_be_between(a_lower_bound,a_upper_bound) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected date)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected dsinterval_unconstrained)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;

  member procedure not_to_be_greater_or_equal(self in ut_expectation, a_expected number) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected number)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;

  member procedure not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_unconstrained)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;

  member procedure not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_ltz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_ltz_unconstrained)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;

  member procedure not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_tz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected timestamp_tz_unconstrained)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;

  member procedure not_to_be_greater_or_equal(self in ut_expectation, a_expected yminterval_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_or_equal(self in ut_expectation, a_expected yminterval_unconstrained)');
    self.not_to( ut_be_greater_or_equal (a_expected) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected date)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected dsinterval_unconstrained)');
    self.not_to( ut_be_greater_than (a_expected) );
  end;

  member procedure not_to_be_greater_than(self in ut_expectation, a_expected number) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected number)');
    self.not_to( ut_be_greater_than (a_expected) );
  end;

  member procedure not_to_be_greater_than(self in ut_expectation, a_expected timestamp_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected timestamp_unconstrained)');
    self.not_to( ut_be_greater_than (a_expected) );
  end;

  member procedure not_to_be_greater_than(self in ut_expectation, a_expected timestamp_ltz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected timestamp_ltz_unconstrained)');
    self.not_to( ut_be_greater_than (a_expected) );
  end;

  member procedure not_to_be_greater_than(self in ut_expectation, a_expected timestamp_tz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected timestamp_tz_unconstrained)');
    self.not_to( ut_be_greater_than (a_expected) );
  end;

  member procedure not_to_be_greater_than(self in ut_expectation, a_expected yminterval_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_greater_than(self in ut_expectation, a_expected yminterval_unconstrained)');
    self.not_to(  ut_be_greater_than (a_expected) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected date)');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected dsinterval_unconstrained)');
    self.not_to( ut_be_less_or_equal (a_expected) );
  end;

  member procedure not_to_be_less_or_equal(self in ut_expectation, a_expected number) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected number)');
    self.not_to( ut_be_less_or_equal (a_expected) );
  end;

  member procedure not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_unconstrained)');
    self.not_to( ut_be_less_or_equal (a_expected) );
  end;

  member procedure not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_ltz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_ltz_unconstrained)');
    self.not_to( ut_be_less_or_equal (a_expected) );
  end;

  member procedure not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_tz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected timestamp_tz_unconstrained)');
    self.not_to( ut_be_less_or_equal (a_expected) );
  end;

  member procedure not_to_be_less_or_equal(self in ut_expectation, a_expected yminterval_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_or_equal(self in ut_expectation, a_expected yminterval_unconstrained)');
    self.not_to(  ut_be_less_or_equal (a_expected) );
  end;
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected date');
  ...
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected dsinterval_unconstrained)');
    self.not_to( ut_be_less_than (a_expected) );
  end;

  member procedure not_to_be_less_than(self in ut_expectation, a_expected number) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected number');
    self.not_to( ut_be_less_than (a_expected) );
  end;

  member procedure not_to_be_less_than(self in ut_expectation, a_expected timestamp_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected timestamp_unconstrained)');
    self.not_to( ut_be_less_than (a_expected) );
  end;

  member procedure not_to_be_less_than(self in ut_expectation, a_expected timestamp_ltz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected timestamp_ltz_unconstrained)');
    self.not_to( ut_be_less_than (a_expected) );
  end;

  member procedure not_to_be_less_than(self in ut_expectation, a_expected timestamp_tz_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected timestamp_tz_unconstrained)');
    self.not_to( ut_be_less_than (a_expected) );
  end;

  member procedure not_to_be_less_than(self in ut_expectation, a_expected yminterval_unconstrained) is
  begin
    ut_utils.debug_log('ut_expectation.not_to_be_less_than(self in ut_expectation, a_expected yminterval_unconstrained)');
    self.not_to(  ut_be_less_than (a_expected) );
  end;

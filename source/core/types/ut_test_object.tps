...
(
  ...
  not instantiable member procedure do_execute(self in out nocopy ut_test_object, a_reporter in out nocopy ut_reporter, a_parent_err_msg varchar2 default null),

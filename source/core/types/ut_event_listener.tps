create or replace type ut_event_listener under ut_event_listener_base(
  ...
  */
  ...
  overriding member procedure fire_on_event(self in out nocopy ut_event_listener, a_event_timing varchar2, a_event_name varchar2, a_item ut_suite_item_base),
  overriding member procedure fire_on_event(self in out nocopy ut_event_listener, a_event_name varchar2)
)
/

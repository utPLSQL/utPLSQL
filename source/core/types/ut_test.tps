create or replace type ut_test under ut_suite_item (
  ...
  */
  ...
  member procedure do_execute(self in out nocopy ut_test, a_listener in out nocopy ut_execution_listener),
  member function do_execute(self in out nocopy ut_test, a_listener in out nocopy ut_execution_listener) return boolean
)
/
create or replace type body ut_test as
  ...
  overriding member procedure do_execute(self in out nocopy ut_test, a_listener in out nocopy ut_listener_interface) is
    l_completed_without_errors boolean;
  begin
    l_completed_without_errors := self.do_execute(a_listener);
  end;

  overriding member function do_execute(self in out nocopy ut_test, a_listener in out nocopy ut_listener_interface) return boolean is
    l_completed_without_errors boolean;

create or replace type ut_suite under ut_suite_item (
  ...
  */
  ...
  member function  do_execute(self in out nocopy ut_suite, a_listener in out nocopy ut_execution_listener) return boolean,
  member procedure do_execute(self in out nocopy ut_suite, a_listener in out nocopy ut_execution_listener),

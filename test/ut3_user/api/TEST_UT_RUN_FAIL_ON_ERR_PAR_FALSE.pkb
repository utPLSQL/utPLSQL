create or replace package body test_ut_run_fail_on_err_par_false is
  ...
  begin
    --Act
    ut3_develop.ut.run('ut3_tester_helper',a_reporter => ut3_develop.ut_documentation_reporter(), a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
    --Assert
    ut.expect( l_results ).to_be_like( '%test_package_1%test_package_2%test_package_3%' );
  end;
  ...
  procedure run_proc_pkg_name is
    l_results clob;
  begin
    ut3_develop.ut.run('ut3_tester_helper.test_package_1' , a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
    --Assert
  ...
  begin
    --Act
    ut3_develop.ut.run('ut3_tester_helper', cast(null as ut3_develop.ut_reporter_base), a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
    --Assert
  ...
  procedure run_proc_warn_on_commit is
    l_results clob;
  begin
    ut3_develop.ut.run('test_commit_warning', a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
  ...
  procedure run_proc_fail_child_suites is
    l_results clob;
  begin
    ut3_develop.ut.run('child_suite', a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
    ut.expect(l_results).to_be_like(
      '%1) does_stuff%' ||
  ...
  begin
    ...
    --Act
    ut3_develop.ut.run('test_transaction.insert_row', a_force_manual_rollback => true, a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
  ...
  begin
    ...
    --Act
    ut3_develop.ut.run('test_transaction.insert_and_raise', a_force_manual_rollback => true, a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
  ...
  begin
    ...
    --Act
    ut3_develop.ut.run('test_transaction.insert_row', a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
...
%1 tests, 0 failed, 0 errored, 0 disabled, 1 warning(s)%');
  ...
  procedure savepoints_on_db_links is
    l_results clob;
  begin
    ut3_develop.ut.run('ut3_tester_helper.test_distributed_savepoint', a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
  ...
  procedure run_proc_pkg_name_tag is
    l_results clob;
  begin
    ut3_develop.ut.run('ut3_tester_helper.test_package_1',a_tags => 'suite1test1', a_fail_on_errors => false);
    l_results :=  ut3_tester_helper.main_helper.get_dbms_output_as_clob();
    --Assert
    ut.expect( l_results ).to_be_like( '%test_package_1%' );

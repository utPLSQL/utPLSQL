create or replace package body test_expect_to_be_less_than is
  ...
  function not_to_be_less_than_block(
    a_data_type varchar2,
    a_actual    varchar2,
    a_expected  varchar2
  ) return varchar2 is
  ...
  begin
    --Act
    ut3_develop.ut.expect(to_clob('3')).to_( ut3_develop.be_less_than(4) );
    --Assert
    ut.expect(ut3_tester_helper.main_helper.get_failed_expectations_num).to_be_greater_than(0);
  end;

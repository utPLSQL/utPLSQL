...
20be951ab0       320  package body SCH_TEST.UT
    ...
    ut.expect(
        ut3_develop.ut_expectation_processor.who_called_expectation(l_stack_trace)
...
at "'||gc_user||'.TEST_EXPECTATION_PROCESSOR", line 24');
  ...
  object      line  object
  handle    number  name
0x80e701d8        26  UT3_DEVELOP.UT_EXPECTATION_RESULT
0x85e10150       112  UT3_DEVELOP.UT_EXPECTATION
0x8b54bad8        21  UT3_DEVELOP.UT_EXPECTATION_NUMBER
0x85cfd238        20  package body UT3_DEVELOP.UT_EXAMPLETEST
...
0x8a116010        76  UT3_DEVELOP.UT_TEST
0x8a3348a0        48  UT3_DEVELOP.UT_SUITE_ITEM
0x887e9948        67  UT3_DEVELOP.UT_LOGICAL_SUITE
0x8a26de20        59  UT3_DEVELOP.UT_RUN
0x8a3348a0        48  UT3_DEVELOP.UT_SUITE_ITEM
0x838d17c0        28  anonymous block
]';
    ut.expect(
        ut3_develop.ut_expectation_processor.who_called_expectation(l_stack_trace)
    ).to_be_like('at "UT3_DEVELOP.UT_EXAMPLETEST", line 20 %');
  end;
...
00007FF852BCFC68       142  type body UT3_DEVELOP.UT_EXECUTABLE.DO_EXECUTE
00007FF852BCFC68        44  type body UT3_DEVELOP.UT_EXECUTABLE.DO_EXECUTE
00007FF8512F9A90        74  type body UT3_DEVELOP.UT_EXECUTABLE_TEST.DO_EXECUTE
00007FF8512F9A90        38  type body UT3_DEVELOP.UT_EXECUTABLE_TEST.DO_EXECUTE
00007FF8231A2088        79  type body UT3_DEVELOP.UT_TEST.DO_EXECUTE
00007FF81FF207B0        49  type body UT3_DEVELOP.UT_SUITE_ITEM.DO_EXECUTE
00007FF852C83270        66  type body UT3_DEVELOP.UT_SUITE.DO_EXECUTE
00007FF82165F3B0        67  type body UT3_DEVELOP.UT_RUN.DO_EXECUTE
00007FF81FF207B0        49  type body UT3_DEVELOP.UT_SUITE_ITEM.DO_EXECUTE
00007FF8266285C0       172  package body UT3_DEVELOP.UT_RUNNER.RUN
00007FF854710538       134  package body UT3_DEVELOP.UT.RUN_AUTONOMOUS
00007FF854710538       488  package body UT3_DEVELOP.UT.RUN
00007FF854710538       623  package body UT3_DEVELOP.UT.RUN
